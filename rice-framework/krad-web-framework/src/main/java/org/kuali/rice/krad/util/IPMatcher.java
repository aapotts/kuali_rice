...
public class IPMatcher
{
     ...
     *             somehow malformed)
     */
    public IPMatcher(String ipSpec) throws RuntimeException
    {
        ...
        { // looks like IPv6
            ...
            case 2: // CIDR notation:  calculate the mask
                ...
                if (maskBits < 0 || maskBits > 128)
                    throw new RuntimeException("Mask bits out of range 0-128 "
                            + ipSpec);
            ...
            case 1: // No explicit mask:  fill the mask with 1s
                ...
                break;
            default:
                throw new RuntimeException("Malformed IP range specification "
                        + ipSpec);
            }
        }
        else
            ...
            throws RuntimeException
    {
        ...
        {
            throw new RuntimeException("Malformed IP specification " + ip);
        }
        ...
        try
        {
            ...
            for (int i = 0; i < parts.length; i++)
            {
                ...
                if (p < 0 || p > 255)
                {
                    throw new RuntimeException("Malformed IP specification "
                            + ip);
     ...
     *             malformed)
     */
    public boolean match(String ipIn) throws RuntimeException
    {
        byte[] candidate;
        ...
        if (ipIn.indexOf(':') < 0)
        {
            ...
            {
                throw new RuntimeException("Malformed IPv6 address ",e);
            }
